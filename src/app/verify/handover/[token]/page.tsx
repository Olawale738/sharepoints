...
export default async function HandoverVerificationPage({ params }: { params: Promise<{ token: string }> }) {
        ...
        <div className="bg-[#0b1b3d] px-6 py-6 text-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-2 text-2xl font-semibold">LETW Handover Verification</h1>
            </div>
          </div>
        </div>
        <div className="p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-ink/60">
                  This page confirms current registry status only. It does not expose confidential handover details or secure asset references.
                </p>
              </div>
            </div>
          </div>
